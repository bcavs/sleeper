            ...
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-2">
                <p className="font-bold">
                  Promotions and Relegations are based on a combination of
                  regular season record and playoffs.
                </p>
                <div className="pl-8">
                  <p>
                  ...
                  <p>
                    2. The next two promotion spots are determined by the
                    highest two regular season records. Tie breakers are settled
                    by standings provided by the Sleeper App
                  </p>
                  <p>
                    3. The 4 teams with the lowest regular season records from
                    the top league will be relegated.
                  </p>
                </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="pl-8">
                  ...
                  <p>
                    Bottom league sends 10% ($80) of their prize pot to the top
                    league, which gets paid to the champion.
                  </p>
